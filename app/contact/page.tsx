        ...
        <main className="  py-12 ">
          ...
          <section className="text-center  mx-auto ">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              At A1, we welcome your inquiries, feedback, and collaboration.
              Reach out via any channel below and our team will assist you
              promptly.
            </p>
          </section>
          ...
          <section className="grid mx-auto w-[60%] md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Your privacy matters. We adhere to strict policies and never
