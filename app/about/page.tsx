              ...
              <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                <div className="space-y-4 md:space-y-6 text-center md:text-left">
                  ...
                  <p className="text-white/90 text-base md:text-lg">
                    ...
                    technology that enhances the learning experience. We create
                    intuitive tools that make teaching more effective and
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto text-center mb-10 md:mb-16">
                ...
                <p className="text-gray-600">
                  ...
                  education more accessible and engaging through technology.
                  What started as a small team of passionate educators and
                  developers has grown into a comprehensive learning platform
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
                ...
                <div className="bg-[#f1f3f4] p-6 md:p-8 rounded-lg text-center">
                  ...
                  <p className="text-gray-600">
                    ...
                    enterprise-grade protection and regular audits.
                  </p>
                </div>
                <div className="bg-[#f1f3f4] p-6 md:p-8 rounded-lg text-center sm:col-span-2 md:col-span-1">
                  ...
                  <p className="text-gray-600">
                    Join our growing community of educators and learners to
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          We constantly push the boundaries of what is possible
                ...
                {[1, 2, 3].map((i) => (
                  ...
                  >
                    ...
                    <p className="text-gray-600 mb-6">
                      `&quot;This platform has completely transformed how I
                      teach my classes. The tools are intuitive and my students
